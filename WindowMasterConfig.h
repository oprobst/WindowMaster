...
#define ZERO_K -273.15 //very cold... :)
/*
...
//list of sensors found which are not in the ds18b20_sensors const list
extern short unknown_ds18b20_sensors[16][BYTE_SIZE_ADDRESS];
